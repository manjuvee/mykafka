...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaBody) DeepCopyInto(out *KafkaBody) {
	*out = *in
	if in.Listeners != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaBody.
func (in *KafkaBody) DeepCopy() *KafkaBody {
	if in == nil {
		return nil
	}
	out := new(KafkaBody)
...
func (in *KafkaSpec) DeepCopyInto(out *KafkaSpec) {
	*out = *in
	if in.KafkaBody != nil {
		in, out := &in.KafkaBody, &out.KafkaBody
		*out = new(KafkaBody)
		(*in).DeepCopyInto(*out)
	}
	if in.Zookeeper != nil {
